...
- **Paso 1:** Demostración Exitosa
    ...
    - Muestra que se está ejecutando un flujo de trabajo llamado **"Validar Nombres de Archivos".**
        <p align="center">
            <img src="imagenes/workflow-run-paso1.png" alt="workflow-run-paso1" width="60%">
        </p>
    - Cuando termina, debería mostrar un ícono verde de éxito. 
        <p align="center">
            <img src="imagenes/workflow-run-paso1-end.png" alt="workflow-run-paso1-end" width="60%">
        </p>
